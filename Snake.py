...
def randAppleGen():
    AppleSize=30
    randAppleX = round(random.randrange(0, display_width-AppleSize-10))#/10.0)*10.0
    randAppleY = round(random.randrange(0, display_height-AppleSize-10))#/10.0)*10.0
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("If you run into yourself you lose",
                         black,
                         50)
